...
function DropZone({ label, multiple = false, files, onFiles }) {
  ...
  const handleDrop = reactExports.useCallback(
    (e) => {
      ...
      const dropped = Array.from(e.dataTransfer.files).map((f) => {
        try {
          return window.bmp.getPathForFile(f);
        } catch {
          return "";
        }
      }).filter(Boolean);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        className: `
          ...
          ${dragging ? "border-accent bg-accent/5 scale-[1.01]" : "border-border bg-surface hover:border-[#2e2e2e] hover:bg-[#161616]"}
        `,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", className: dragging ? "text-accent" : "text-text-secondary", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M10 2v12M4 8l6-6 6 6", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M3 16h14", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13.7px] font-medium text-text-secondary uppercase tracking-widest", children: label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11.7px] text-text-muted", children: multiple ? "Drop multiple images" : "Drop an image" })
        ]
      }
    ),
    files.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 max-h-[80px] overflow-y-auto", children: files.map((path, idx) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded overflow-hidden flex-shrink-0 bg-[#1e1e1e]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: `localfile://${path}`,
                alt: "",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11.7px] text-text-secondary max-w-[80px] truncate", children: name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => removeFile(idx),
                className: "ml-0.5 text-text-muted hover:text-text-primary transition-colors opacity-0 group-hover:opacity-100",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "10", height: "10", viewBox: "0 0 10 10", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M2 2l6 6M8 2l-6 6", stroke: "currentColor", strokeWidth: "1.2", strokeLinecap: "round" }) })
              }
            )
          ]
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-2 border-b border-border", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: copy,
          className: `
            flex items-center gap-1.5 text-[11.7px] font-medium uppercase tracking-widest
            px-2.5 py-1 rounded border transition-all duration-150
            ${copied ? "border-accent text-accent bg-accent/10" : "border-border text-text-secondary hover:border-[#2e2e2e] hover:text-text-primary"}
          `,
          children: copied ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "10", height: "10", viewBox: "0 0 10 10", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M1.5 5l2.5 2.5 4.5-4.5", stroke: "currentColor", strokeWidth: "1.3", strokeLinecap: "round", strokeLinejoin: "round" }) }),
            "Copied"
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "10", height: "10", viewBox: "0 0 10 10", fill: "none", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "3", y: "3", width: "6", height: "6", rx: "1", stroke: "currentColor", strokeWidth: "1.2" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M7 3V2a1 1 0 00-1-1H2a1 1 0 00-1 1v4a1 1 0 001 1h1", stroke: "currentColor", strokeWidth: "1.2", strokeLinecap: "round" })
            ] }),
            "Copy"
          ] })
        }
...
function SeedanceLogo() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 3C7 3 3 7 3 12s4 9 9 9 9-4 9-9-4-9-9-9z", stroke: "currentColor", strokeWidth: "1.6" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M8 12c0-2.2 1.8-4 4-4s4 1.8 4 4-1.8 4-4 4", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "12", cy: "12", r: "1.5", fill: "currentColor" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans font-semibold text-[14.7px] tracking-wide", children: "Seedance 2" })
  ] });
}
function Pill({ active, disabled: dis, onClick: h, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: h, disabled: dis, className: `px-2.5 py-[7px] rounded-md text-[11.7px] font-mono font-semibold tracking-wide border transition-all duration-150 ${active ? "border-white/50 bg-white/10 text-white" : "border-border bg-transparent text-text-muted hover:border-white/25 hover:text-white/70"} ${dis ? "cursor-not-allowed opacity-40" : "cursor-pointer"}`, children });
}
function AccentPill({ active, disabled: dis, onClick: h, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: h, disabled: dis, className: `px-2.5 py-[7px] rounded-md text-[11.7px] font-mono font-semibold tracking-wide border transition-all duration-150 ${active ? "border-accent/70 bg-accent/10 text-accent" : "border-border bg-transparent text-text-muted hover:border-accent/30 hover:text-accent/60"} ${dis ? "cursor-not-allowed opacity-40" : "cursor-pointer"}`, children });
}
...
function UpdateBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 border-b border-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-surface", children: [
    phase === "downloading" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    phase === "ready" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-y-0 left-0 bg-accent/10 w-full" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-between px-5 py-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 min-w-0", children: [
        phase === "available" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent text-[11.7px]", children: "↓" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11.7px] font-mono text-text-secondary tracking-wide", children: [
            "BMP ",
            version && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-text-primary", children: version }),
            " disponible · iniciando descarga..."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, {})
        ] }),
        phase === "downloading" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent text-[11.7px]", children: "↓" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11.7px] font-mono text-text-secondary tracking-wide", children: [
            "BMP ",
            version && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-text-primary", children: version }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-px bg-border relative overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11.7px] font-mono text-accent tabular-nums", children: [
              percent ?? 0,
              "%"
            ] })
          ] })
        ] }),
        phase === "installing" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent text-[11.7px]", children: "⚙" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11.7px] font-mono text-text-secondary tracking-wide", children: [
            "BMP ",
            version && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-text-primary", children: version }),
        ...
        phase === "ready" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11.7px] font-mono text-text-secondary tracking-wide", children: [
            "BMP ",
            version && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-text-primary", children: version }),
            " instalada · reiniciando"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, {})
        ] }),
        phase === "error" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-400 text-[11.7px]", children: "⚠" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11.7px] font-mono text-red-400/70 tracking-wide truncate", children: error ?? "Error al verificar actualizaciones" })
        ] })
      ] }),
...
function Spinner() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "animate-spin text-accent", width: "10", height: "10", viewBox: "0 0 10 10", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "5", cy: "5", r: "3.5", stroke: "currentColor", strokeWidth: "1.2", strokeDasharray: "6 4", strokeLinecap: "round" }) });
}
function SettingsModal({ onClose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface border border-border rounded-xl p-6 w-[420px] flex flex-col gap-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading font-bold text-text-primary text-[14.7px] uppercase tracking-widest", children: "Settings" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: onClose,
              className: "text-text-muted hover:text-text-secondary transition-colors",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M2 2l10 10M12 2L2 12", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }) })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[11.7px] font-heading font-semibold uppercase tracking-widest text-text-secondary", children: "Output Folder" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11.7px] text-text-muted leading-relaxed", children: "Las imágenes generadas por Higgsfield se guardarán en esta carpeta." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 bg-bg border border-border rounded-lg px-3 py-2 min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12.7px] font-mono text-text-secondary truncate", title: outputPath, children: outputPath || "—" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            ${saved ? "border-green-500/40 bg-green-500/10 text-green-400" : !outputPath ? "border-border text-text-muted cursor-not-allowed" : "border-accent bg-accent text-bg hover:bg-accent/90 active:scale-[0.99]"}
          `,
...
function PromptHistoryModal({ onUse, onClose }) {
  ...
  const filtered = entries.filter(
    (e) => !search || e.description.toLowerCase().includes(search.toLowerCase()) || e.prompt.toLowerCase().includes(search.toLowerCase())
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/70 flex items-start justify-center z-50 pt-16", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-border flex-shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading font-bold text-text-primary text-[13.7px] uppercase tracking-widest", children: "Prompt History" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onClose, className: "text-text-muted hover:text-text-primary transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M2 2l10 10M12 2L2 12", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" }) }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-2 border-b border-border flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ref: searchRef,
            value: search,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-y-auto flex-1", children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-text-muted text-[12.7px] py-8 font-mono", children: "No prompts found" }) : filtered.map((entry) => {
          const isExpanded = expanded === entry.id;
          const date = new Date(entry.timestamp).toLocaleDateString("es-CO", { month: "short", day: "numeric", hour: "2-digit", minute: "2-digit" });
          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border/50 last:border-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 px-4 py-3 hover:bg-white/[0.02] transition-colors", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `mt-0.5 flex-shrink-0 text-[11px] ${entry.fired ? "text-yellow-500" : "text-text-muted/30"}`, children: "★" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-2 mb-0.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13.7px] text-text-primary font-medium truncate", children: entry.description }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-text-muted font-mono flex-shrink-0", children: date }),
                entry.aspectRatio && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-mono text-text-muted/60 flex-shrink-0", children: entry.aspectRatio })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-[12px] font-mono text-text-muted leading-relaxed ${isExpanded ? "" : "line-clamp-2"}`, children: entry.prompt }),
              entry.prompt.length > 120 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
...
function VideoMode({ prompt, onPrompt, frames, onFrames, progress }) {
  ...
  const missingTags = reactExports.useMemo(() => {
    const matches = [...prompt.matchAll(/@Image(\d+)/gi)];
    return matches.map((m) => parseInt(m[1])).filter((n) => n > frames.length);
  }, [prompt, frames.length]);
  const insertTag = (index) => {
    const tag = `@Image${index + 1}`;
    const el = textareaRef.current;
    if (!el) {
      onPrompt(prompt + (prompt.endsWith(" ") ? "" : " ") + tag + " ");
      return;
    }
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[11.7px] font-heading font-semibold uppercase tracking-widest text-text-secondary", children: "Frames" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-text-muted font-mono", children: "drag · max 9" })
            ] }),
            frames.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] text-text-muted font-mono", children: [
              frames.length,
              "/9 · click thumbnail to insert tag"
            ] })
          ] }),
          frames.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-5 gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "22", height: "22", viewBox: "0 0 24 24", fill: "none", className: "text-text-muted", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "3", y: "3", width: "18", height: "18", rx: "3", stroke: "currentColor", strokeWidth: "1.5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "8.5", cy: "8.5", r: "1.5", fill: "currentColor" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M3 15l5-5 4 4 3-3 6 6", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11.7px] text-text-muted font-heading uppercase tracking-widest", children: "Drop frames here" })
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `absolute bottom-0 left-0 right-0 text-[9px] font-mono font-bold text-center py-0.5 transition-colors ${used ? "bg-accent/80 text-black" : "bg-black/70 text-white/70"}`, children: [
                      "@Image",
                      i + 1
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            frames.length < 9 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 border border-dashed border-border rounded-md flex items-center justify-center text-text-muted hover:border-white/30 hover:text-white/60 transition-all text-[20px] cursor-default flex-shrink-0", children: "+" })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface border border-border rounded-lg p-3 flex flex-col gap-2 flex-1 min-h-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        missingTags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[11px] font-mono text-orange-400/80", children: [
          "⚠ @Image",
          missingTags[0],
          missingTags.length > 1 ? `–${missingTags[missingTags.length - 1]}` : "",
          " not in frames"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
        {
          ...
          placeholder: frames.length > 0 ? `Use @Image1${frames.length > 1 ? ", @Image2..." : ""} to reference your frames. Ej: "@Image1 first frame disassembly render to cap building, @Image2 enters floating in 3d render..."` : "Drop frames above, then write your video prompt using @Image1, @Image2... tags to reference them.",
...
function App() {
  ...
  const [videoModel, setVideoModel] = reactExports.useState("seedance-2");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-screen bg-bg overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar-drag flex items-center justify-between px-5 h-11 flex-shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar-nodrag flex items-center gap-3 translate-y-[1px]", style: { marginLeft: "72px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading font-bold text-base text-text-primary tracking-tight", children: "BMP" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-text-muted text-[13.7px]", children: "·" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-text-secondary text-[13.7px] font-medium tracking-wide", children: "Brotherhood Marketing Prompts" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar-nodrag flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11.7px] text-text-muted font-mono tracking-widest uppercase", children: "brotherhood.com.co" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: reset, className: "text-[11.7px] text-text-muted hover:text-text-secondary uppercase tracking-widest transition-colors", children: "Reset" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setShowSettings(true), className: "text-text-muted hover:text-text-secondary transition-colors", title: "Settings", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "7", cy: "7", r: "2", stroke: "currentColor", strokeWidth: "1.25" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M7 1v1.5M7 11.5V13M1 7h1.5M11.5 7H13M2.697 2.697l1.06 1.06M10.243 10.243l1.06 1.06M2.697 11.303l1.06-1.06M10.243 3.757l1.06-1.06", stroke: "currentColor", strokeWidth: "1.25", strokeLinecap: "round" })
        ] }) })
      ] })
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface border border-border rounded-lg p-3 flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-[11.7px] font-heading font-semibold uppercase tracking-widest text-text-secondary", children: [
            "References ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-text-muted", children: "(composition / mood)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropZone, { label: "+ Add refs", multiple: true, files: refs, onFiles: setRefs })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface border border-border rounded-lg p-3 flex flex-col gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-[11.7px] font-heading font-semibold uppercase tracking-widest text-text-secondary", children: [
            "Product ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-text-muted", children: "(Brotherhood garment)" })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: generateStatus === "loading" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center justify-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "animate-spin", width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "7", cy: "7", r: "5.5", stroke: "currentColor", strokeWidth: "1.5", strokeDasharray: "8 6", strokeLinecap: "round" }) }),
              "Generating with Claude..."
            ] }) : "Generate Prompt"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setShowHistory(true), title: "Prompt history", className: "px-3 py-3 rounded-lg border border-border text-text-muted hover:text-text-primary hover:border-white/25 transition-all duration-150", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "7", cy: "7", r: "5.5", stroke: "currentColor", strokeWidth: "1.25" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0 border-t border-border px-5 py-2 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12.7px] text-text-muted font-mono tracking-widest uppercase", children: footerLabel }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        memoryStats && memoryStats.total > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[12.7px] font-mono text-text-muted", children: [
          "memory: ",
          memoryStats.total,
          " prompts · ",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-yellow-600/70", children: [
            "★ ",
            memoryStats.fired,
            " fired"
          ] })
        ] }),
        credits && credits.credits !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(CreditsRing, { credits: credits.credits, plan: credits.plan ?? "" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[12.7px] text-text-muted font-mono", children: [
          "BMP v",
          appVersion || "—"
        ] })
      ] })
...
const CREDITS_MAX = 1e3;
function CreditsRing({ credits, plan }) {
  const R = 6;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "16", height: "16", viewBox: "0 0 16 16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "8", cy: "8", r: R, stroke: "currentColor", strokeWidth: "2", fill: "none", className: "text-white/10" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "8", cy: "8", r: R, stroke: "currentColor", strokeWidth: "2", fill: "none", className: "text-accent", strokeDasharray: `${dash} ${CIRC}`, strokeLinecap: "round", transform: "rotate(-90 8 8)" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[12.7px] font-mono text-text-muted tabular-nums", children: [
      credits,
      " cr"
    ] }),
    plan && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12.7px] font-mono text-text-muted/40 uppercase tracking-widest", children: plan })
  ] });
}
