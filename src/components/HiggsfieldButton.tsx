...
function HiggsfieldLogo() {
  return (
    <span className="flex items-center gap-2">
      ...
      <span className="font-sans font-semibold text-sm tracking-wide">Higgsfield</span>
    </span>
  )
}
        ...
        >
          {isLoading ? (
            <>
              ...
              <span className="text-[11px] font-heading font-semibold uppercase tracking-widest">Generating...</span>
            </>
          ) : status === 'done' ? (
            <>
              ...
              <span className="text-[11px] font-heading font-semibold uppercase tracking-widest">Done — check Desktop</span>
            </>
          ) : status === 'error' ? (
