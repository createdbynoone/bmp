  ...
  return (
    <div className="flex flex-col h-screen bg-bg overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-4">
        ...
        {!prompt && generateStatus === 'idle' && (
          <div className="flex-1 flex items-center justify-center py-6">
            <p className="text-[11.7px] text-text-muted uppercase tracking-[0.2em] font-heading">
      ...
      <div className="flex-shrink-0 border-t border-border px-5 py-2 flex items-center justify-between">
        <span className="text-[12.7px] text-text-muted font-mono tracking-widest uppercase">
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
          <div className="bg-surface border border-border rounded-xl p-6 w-80 flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[13.7px] text-text-secondary leading-relaxed">
